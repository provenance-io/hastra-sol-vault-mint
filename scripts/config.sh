...
copy_idl_types() {
  local default_type_dest="../../hastra-fi-nexus-flow/src/types/hastra-sol-vault-mint.ts"
  local default_idl_dest="../../hastra-fi-nexus-flow/src/types/idl/hastra-sol-vault-mint.ts"
  echo ""
  read -p "Enter destination for hastra_sol_vault_mint.ts TYPE [$default_type_dest]: " dest_type
  read -p "Enter destination for hastra_sol_vault_mint.ts IDL  [$default_idl_dest]: " dest_idl
  echo ""
  dest_type="${dest_type:-$default_type_dest}"
  dest_idl="${dest_idl:-$default_idl_dest}"
  cp ../target/types/hastra_sol_vault_mint.ts "$dest_type"
